...
{
    public abstract class CircularDirection<T, U> : Circular<T, U>, IPointIterator<U>, IDirection<T>
    {
        ...
        // The string presentation of this circular direction.
        public override string ToString()
        {
            return directionHelper.SharedDirection.ToString() + "\n" + base.ToString();
        }
        ...
        protected void CreateCDirection(Direction<T, U> directionHelper)
        {
