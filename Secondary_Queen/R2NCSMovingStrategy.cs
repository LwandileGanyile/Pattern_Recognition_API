...
{
    public class R2NCSMovingStrategy : CShapeMovingStrategy<R2CDirection, R2CDirection, Secondary_Direction>
    {
        private Secondary_Trace_Type traceType;

        public Secondary_Trace_Type TraceType { get; set; }

        public R2NCSMovingStrategy()
        {
        ...
        public R2NCSMovingStrategy(List<R2CDirection> movingStrategy, Secondary_Trace_Type traceType)
        {

        }

        public R2NCSMovingStrategy(List<int> movingStrategy, Secondary_Trace_Type traceType)
        {
